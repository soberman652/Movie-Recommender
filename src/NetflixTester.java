...
public class NetflixTester {
	...
	public static final String baseFile = "dataset" + FileIO.fileSeparator + "1Ratings.csv";
	public static final String testFile = "dataset" + FileIO.fileSeparator + "1Tests.csv";
	...
	public static void main(String[] args) {
		...
		
		{
			...
			ArrayList<String> baseDataLines = reader.readFile(baseFile);
		...
		ArrayList<String> testDataLines = reader.readFile(testFile);
...
//				System.out.println("User: " + userToTest + "  Movie: "+ movieToTest+ "  Guess: "+ guessStars + "    Actual: " + actualStars + "   TotalDifference: "+ totalDifference);
